...
<!--
نویسنده: ساتراس وب
محصولات نام: مترونیک | Bootstrap HTML, VueJS, React, Angular, Asp.Net Core, Rails, Spring, Blazor, Django, Flask & Laravel Admin داشبورد Theme
...
<head><base href="../../"/>
    ...
    <meta property="og:title" content="مترونیک | Bootstrap HTML, VueJS, React, Angular, Asp.Net Core, Rails, Spring, Blazor, Django, Flask & Laravel Admin داشبورد Theme" />
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                    ...
                    <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 me-2">
                                <!--begin::کاربرname-->
                                <a href="#" class="text-white text-hover-primary fs-6 fw-bold">پیمان ابدی</a>
                                <!--end::کاربرname-->
                                <!--begin::توضیحات-->
                                <span class="text-gray-600 fw-semibold d-block fs-8 mb-1">برنامه نویس پایتون</span>
                                <!--end::توضیحات-->
                                <!--begin::Tags-->
                            ...
                            <div class="me-n2">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="../../demo8/dist/account/overview.html" class="menu-link px-5">پروفایل من</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                    ...
                                    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                                        ...
                                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="../../demo8/dist/account/referrals.html" class="menu-link px-5">مراجعات</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="../../demo8/dist/account/billing.html" class="menu-link px-5">صورتحساب</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="../../demo8/dist/account/statements.html" class="menu-link px-5">درگاه ها</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="../../demo8/dist/account/statements.html" class="menu-link d-flex flex-stack px-5">بیانه ها
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <a href="../../demo8/dist/account/statements.html" class="menu-link px-5">من بیانه ها</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                                    <div class="separator my-2"></div>
                                    ...
                                    <div class="menu-item px-5 my-1">
                                        <a href="../../demo8/dist/account/settings.html" class="menu-link px-5">اکانت تنظیمات</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <a href="../../demo8/dist/authentication/layouts/corporate/sign-in.html" class="menu-link px-5">خروج</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                ...
                <div class="aside-search py-5">
                    ...
                    <div id="kt_header_search" class="header-search d-flex align-items-center w-100" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="false" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
                        ...
                        <form data-kt-search-element="form" class="w-100 position-relative" autocomplete="off">
                            ...
                            <!--end::Icon-->
                            <!--begin::Input-->
                            <input type="text" class="search-input form-control ps-13 fs-7 h-40px" name="search" value="" placeholder="جستجو سریع" data-kt-search-element="input" />
                            <!--end::Input-->
                            <!--begin::Spinner-->
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                                ...
                                                <span class="fs-7 fw-semibold text-muted">System مدیر</span>
                                            </div>
                                            <!--end::Title-->
                                        </a>
                                        <!--end::آیتم-->
                                ...
                                <div class="" data-kt-search-element="main">
                                    ...
                                    <div class="d-flex flex-stack fw-semibold mb-4">
                                        ...
                                        <div class="d-flex" data-kt-search-element="toolbar">
                                            ...
                                            <div data-kt-search-element="advanced-options-form-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary me-n1" data-bs-toggle="tooltip" title="مشاهده بیشتر ...arch options">
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="nav-group nav-group-fluid">
                                        ...
                                        <!--begin::Option-->
                                        <label>
                                            <input type="radio" class="btn-check" name="type" value="کاربران" />
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="../../demo8/dist/pages/search/horizontal.html" class="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">جستجو</a>
                                </div>
                                <!--end::Actions-->
                            </form>
                            <!--end::اولویت ها-->
                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                                    ...
                                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link" href="../../demo8/dist/authentication/email/promo-1.html">
                                                ...
                                                <span class="menu-title">تبلیغاتی 1</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link" href="../../demo8/dist/authentication/email/promo-2.html">
                                                ...
                                                <span class="menu-title">تبلیغاتی 2</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link" href="../../demo8/dist/authentication/email/promo-3.html">
                                                ...
                                                <span class="menu-title">تبلیغاتی 3</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    ...
                                    <a class="menu-link" href="../../demo8/dist/pages/pricing/column.html">
                                        ...
                                        <span class="menu-title">ستون قیمت گذاری</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link active" href="../../demo8/dist/apps/projects/users.html">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                        <span class="menu-title">کاربران</span>
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/getting-started/changelog" target="blank">
                                ...
                                <span class="menu-title">تغییرات v8.1.5</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
            ...
            <div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
                <a href="https://preview.keenthemes.com/html/metronic/docs" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="200+ کامپوننت ها و افزونه های شخص ثالث">
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div id="kt_header" style="" class="header align-items-stretch">
                ...
                <div class="header-brو">
                    ...
                    <!--end::کناری minimize-->
                    <!--begin::کناری toggle-->
                    <div class="d-flex align-items-center d-lg-none ms-n3 me-1" title="مشاهده aside menu">
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">پروژه های کاربران</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                <!--begin::آیتم-->
                                <li class="breadcrumb-item text-muted">
                                    <a href="../../demo8/dist/index.html" class="text-muted text-hover-primary">خانه</a>
                                </li>
                                <!--end::آیتم-->
                                <!--begin::آیتم-->
                        ...
                        <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Tags-->
                                <span class="fs-7 fw-bold text-gray-700 pe-4 text-nowrap d-none d-xxl-block">ترتیب:</span>
                                <!--end::Tags-->
                                <!--begin::انتخاب-->
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="card mb-8">
                            <div class="card-body pt-9 pb-0">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <!--end::وضعیت-->
                                                <!--begin::توضیحات-->
                                                <div class="d-flex flex-wrap fw-semibold mb-4 fs-5 text-gray-400">#1 Tool to get started with Web اپلیکیشن ها any Kind & size</div>
                                                <!--end::توضیحات-->
                                            </div>
                                            <!--end::Details-->
                                            <!--begin::Actions-->
                                            <div class="d-flex mb-4">
                                                ...
                                                <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">افزودن</a>
                                                <!--begin::Menu-->
                                                <div class="me-0">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-start">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                ...
                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                    <!--begin::شماره کارت-->
                                                    <div class="d-flex align-items-center">
                                                        <div class="fs-4 fw-bold">29 دی, 2022</div>
                                                    </div>
                                                    <!--end::شماره کارت-->
                                                    <!--begin::Tags-->
                                            ...
                                            <div class="symbol-group symbol-hover mb-3">
                                                ...
                                                <a href="#" class="symbol symbol-35px symbol-circle" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">
                                                    <span class="symbol-label bg-dark text-inverse-dark fs-8 fw-bold" data-bs-toggle="tooltip" data-bs-trigger="hover" title="نمایش بیشتر ...ربران">+42</span>
                                                </a>
                                                <!--end::همه کاربران-->
                                            </div>
                                            <!--end::کاربران-->
                                ...
                                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6" href="../../demo8/dist/apps/projects/project.html">بررسی اجمالی</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6" href="../../demo8/dist/apps/projects/targets.html">اهداف</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6" href="../../demo8/dist/apps/projects/budget.html">بودجه</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6 active" href="../../demo8/dist/apps/projects/users.html">کاربران</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6" href="../../demo8/dist/apps/projects/files.html">فایل ها</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6" href="../../demo8/dist/apps/projects/activity.html">فعالیت</a>
                                    </li>
                                    <!--end::Nav item-->
                                    <!--begin::Nav item-->
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary py-5 me-6" href="../../demo8/dist/apps/projects/settings.html">تنظیمات</a>
                                    </li>
                                    <!--end::Nav item-->
                                </ul>
                                <!--end::Nav-->
                        ...
                        <div class="d-flex flex-wrap flex-stack pb-7">
                            ...
                            <div class="d-flex flex-wrap align-items-center my-1">
                                <h3 class="fw-bold me-5 my-1">کاربران (38)</h3>
                                <!--begin::جستجو-->
                            ...
                            <div class="d-flex flex-wrap my-1">
                                ...
                                <div class="d-flex my-0">
                                    <!--begin::انتخاب-->
                                    <select name="status" data-control="select2" data-hide-search="true" data-placeholder="فیلتر" class="form-select form-select-sm border-body bg-body w-150px me-5">
                                        <option value="1">بروزرسانی</option>
                                        <option value="2">ماه اخر</option>
                                        <option value="3">ربع آخر</option>
                                        <option value="4">سال اخر</option>
                                    </select>
                                    <!--end::انتخاب-->
                                    <!--begin::انتخاب-->
                                    <select name="status" data-control="select2" data-hide-search="true" data-placeholder="خروجی" class="form-select form-select-sm border-body bg-body w-100px">
                                        <option value="1">Excel</option>
                                        <option value="1">PDF</option>
                                        <option value="2">پرینت</option>
                                    </select>
                                    <!--end::انتخاب-->
                                </div>
                                <!--end::Actions-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">کارینا کالرک</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">مدیر هنری در شرکت نوویکا</div>
                                                <!--end::جایگاه-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-center flex-wrap">
                                                    ...
                                                    <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                                        ...
                                                        <div class="fw-semibold text-gray-400">درآمد</div>
                                                    </div>
                                                    <!--end::Stats-->
                                                    <!--begin::Stats-->
                                                    <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                                        <div class="fs-6 fw-bold text-gray-700">23</div>
                                                        <div class="fw-semibold text-gray-400">وظیفه ها</div>
                                                    </div>
                                                    <!--end::Stats-->
                                                    <!--begin::Stats-->
                                                    <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                                        <div class="fs-6 fw-bold text-gray-700">$236,400</div>
                                                        <div class="fw-semibold text-gray-400">فروش</div>
                                                    </div>
                                                    <!--end::Stats-->
                                                </div>
                                                <!--end::Info-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">محسن برومند</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">توسعه دهنده at Loop Inc</div>
                                                <!--end::جایگاه-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-center flex-wrap">
                                                    <!--begin::Stats-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">جیمز کاردن</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">طراح سایت در شرکت</div>
                                                <!--end::جایگاه-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-center flex-wrap">
                                                    <!--begin::Stats-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">رابرت دو</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">تجزیه و تحلیل بازاریابی در </div>
                                                <!--end::جایگاه-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-center flex-wrap">
                                                    <!--begin::Stats-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">امید وحیدی</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">مدیر هنری در شرکت </div>
                                                <!--end::جایگاه-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-center flex-wrap">
                                                    <!--begin::Stats-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">محمد ابراهیمی</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">شرکت هنری</div>
                                                <!--end::جایگاه-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-center flex-wrap">
                                                    <!--begin::Stats-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">پیتر جانسون</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">مدیر هنری در شرکت نوویکا</div>
                                                <!--end::جایگاه-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">اکانتant at شماره کارتs Co.</div>
                                                <!--end::جایگاه-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-center flex-wrap">
                                                    <!--begin::Stats-->
                                    ...
                                    <div class="col-md-6 col-xxl-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                ...
                                                <!--end::Avatar-->
                                                <!--begin::نام-->
                                                <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">بهناز محمدی</a>
                                                <!--end::نام-->
                                                <!--begin::جایگاه-->
                                                <div class="fw-semibold text-gray-400 mb-6">مدیر هنری در شرکت نوویکا</div>
                                                <!--end::جایگاه-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="kt_project_users_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold">
                                                ...
                                                <tr>
                                                    <th class="min-w-250px">مدیریت</th>
                                                    <th class="min-w-150px">تاریخ</th>
                                                    <th class="min-w-90px">مقدار</th>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">مرادی نیا</a>
                                                    ...
                                                    <td>فروردین 15, 2022</td>
                                                    <td>$557.00</td>
                                                    <td>
                                                        <span class="badge badge-light-success fw-bold px-4 py-3">تایید شده</span>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="#" class="btn btn-light btn-sm">نمایش</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">میلاد مرادی</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">جلالی</a>
                                                    ...
                                                    <td>$409.00</td>
                                                    <td>
                                                        <span class="badge badge-light-danger fw-bold px-4 py-3">رد شده</span>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="#" class="btn btn-light btn-sm">نمایش</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">محسن برومند</a>
                                                    ...
                                                    <td>$523.00</td>
                                                    <td>
                                                        <span class="badge badge-light-warning fw-bold px-4 py-3">در انتظار</span>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="#" class="btn btn-light btn-sm">نمایش</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">رضا علی ابادی</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">میکائیل کرمانی</a>
                                                    ...
                                                    <td>$894.00</td>
                                                    <td>
                                                        <span class="badge badge-light-info fw-bold px-4 py-3">در حال پیش رفت</span>
                                                    </td>
                                                    <td class="text-end">
                                                        <a href="#" class="btn btn-light btn-sm">نمایش</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">محمد رصایی</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">امید وحیدی</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">علی کاربر</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">الهام بارانی</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">آنا کوهی</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">رابرت دو</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">جواد مولای</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">لقمان کامرانی</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Info-->
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <a href="" class="mb-1 text-gray-800 text-hover-primary">احسان ورزقانی</a>
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                                        ...
                                        <div class="text-center mb-13">
                                            ...
                                            <div class="text-muted fw-semibold fs-5">اگر به اطلاعات بیشتری نیاز دارید ، لطفاً این مورد را بررسی کنید
                                                <a href="#" class="link-primary fw-bold">دایرکتوری کاربران</a>.</div>
                                            <!--end::توضیحات-->
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::کاربران-->
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                                        ...
                                        <div id="kt_modal_users_search_hوler" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="inline">
                                            ...
                                            <form data-kt-search-element="form" class="w-100 position-relative mb-5" autocomplete="off">
                                                ...
                                                <!--end::Icon-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-lg form-control-solid px-15" name="search" value="" placeholder="با نام کاربری ، نام کامل or ایمیل جستجو کنید ..." data-kt-search-element="input" />
                                                <!--end::Input-->
                                                <!--begin::Spinner-->
                                                <span class="position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-5" data-kt-search-element="spinner">
                                                    ...
                                                    <div class="mh-375px scroll-y me-n7 pe-7">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="0">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='0']" value="0" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="1">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='1']" value="1" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='2']" value="2" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='3']" value="3" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="4">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='4']" value="4" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="5">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='5']" value="5" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='6']" value="6" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="7">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='7']" value="7" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="8">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='8']" value="8" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='9']" value="9" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="10">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='10']" value="10" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='11']" value="11" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="12">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='12']" value="12" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='13']" value="13" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="14">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='14']" value="14" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='15']" value="15" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
                                                        ...
                                                        <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="16">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Checkbox-->
                                                                <label class="form-check form-check-custom form-check-solid me-5">
                                                                    <input class="form-check-input" type="checkbox" name="کاربران" data-kt-check="true" data-kt-check-target="[data-user-id='16']" value="16" />
                                                                </label>
                                                                <!--end::Checkbox-->
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px symbol-circle">
...
<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'lg': '900px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_activities_toggle" data-kt-drawer-close="#kt_activities_close">
    <div class="card shadow-none border-0 rounded-0">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                    <!--begin::Title-->
                                    <a href="../../demo8/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">ملاقات با مشتری</a>
                                    <!--end::Title-->
                                    <!--begin::Tags-->
                                    ...
                                    <!--end::پردازش-->
                                    <!--begin::Actions-->
                                    <a href="../../demo8/dist/apps/projects/project.html" class="btn btn-sm btn-light btn-active-light-primary">نمایش</a>
                                    <!--end::Actions-->
                                </div>
                                <!--end::Record-->
                                <!--begin::Record-->
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                    <!--begin::Title-->
                                    <a href="../../demo8/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">آماده سازی تحویل پروژه</a>
                                    <!--end::Title-->
                                    <!--begin::Tags-->
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        ...
                                        <div class="ms-1 fw-semibold">
                                            <!--begin::Desc-->
                                            <a href="../../demo8/dist/apps/projects/project.html" class="fs-6 text-hover-primary fw-bold">دارایی، مالیه، سرمایه گذاری </a>
                                            <!--end::Desc-->
                                            <!--begin::شماره کارت-->
        ...
        <div class="card-footer py-5 text-center" id="kt_activities_footer">
            <a href="../../demo8/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">نمایش تمام فعالیت ها
                ...
                <div class="mb-0">
                    ...
                    <div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
                        <div class="d-flex flex-stack">
                            ...
                            <div class="text-nowrap">
                                <a href="https://rtl-theme.com" class="btn btn-sm btn-success" target="_blank">تماس با ما</a>
                            </div>
                        </div>
                    </div>
                    <!--end::لاینسس شده-->
                    ...
                    <!--begin::دموها-->
                    <div class="mb-0">
                        <h3 class="fw-bold text-center mb-6">دموهای مترونیک</h3>
                        <!--begin::Row-->
                        <div class="row g-5">
                            <!--begin::Col-->
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    ...
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="Https://preview.keenthemes.com/metronic8/demo1" class="btn btn-sm btn-success shadow">مترونیک اصل و نسبal</a>
                                    </div>
                                </div>
                                <!--end::دمو-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    ...
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="Https://preview.keenthemes.com/metronic8/demo22" class="btn btn-sm btn-success shadow">دمو 22</a>
                                    </div>
                                </div>
                                <!--end::دمو-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    ...
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="Https://preview.keenthemes.com/metronic8/demo24" class="btn btn-sm btn-success shadow">دمو 24</a>
                                    </div>
                                </div>
                                <!--end::دمو-->
                            </div>
        ...
        <div class="card-body" id="kt_help_body">
            ...
            <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
                ...
                <div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
                    <!--begin::Heading-->
                    <h2 class="fw-bold mb-5">پشتیبانی
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="Https://preview.keenthemes.com/metronic8/layout-builder.html" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">قالب بندی سازنده</a>
                            <!--end::Title-->
                            <!--begin::توضیحات-->
...
<div class="engage-toolbar d-flex position-fixed px-5 fw-bold zindex-2 top-50 end-0 transform-90 mt-5 mt-lg-20 gap-2">
    ...
    <button id="kt_engage_demos_toggle" class="engage-demos-toggle engage-btn btn shadow-sm fs-6 px-4 rounded-top-0" title="بیشتر " data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
    ...
    <div class="modal-dialog mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <!--end::Separator-->
                <!--begin::Textarea-->
                <textarea class="form-control form-control-solid mb-8" rows="3" placeholder="ایمیل خود را اینجا وارد کنید"></textarea>
                <!--end::Textarea-->
                <!--begin::کاربران-->
                <div class="mb-10">
                    <!--begin::Heading-->
                ...
                <form id="kt_modal_new_target_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            ...
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="مدت ها قبل از نشستن برای قرار دادن قلم دیجیتال روی کاغذ ، باید مطمئن شوید که باید بنشینید و بنویسید"></i>
                        </label>
                        <!--end::Tags-->
...
<script src="assets/js/custom/apps/projects/users/کاربران.js"></script>
<script src="assets/js/widgets.bundle.js"></script>
<script src="assets/js/custom/widgets.js"></script>
<script src="assets/js/custom/apps/chat/chat.js"></script>
<script src="assets/js/custom/utilities/modals/کاربران-search.js"></script>
